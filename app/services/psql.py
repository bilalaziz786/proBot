...
class PSQL:
    ...
    def _psql_connection(self):
        ...
        try:
            ...
            logger.info("ERROR: Unable to connect to PostgreSQL Server. - {}".format(e))
            sys.exit()
...
class DBService:
    ...
    def search_query(self, query, table=TABLE_NAME, limit=3):
        ...
        cursor.execute(
            "SELECT content, created_by FROM {} WHERE content like '%{}%' order by created_at DESC LIMIT {};".format(
                table, query, limit))
